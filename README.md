...
```
npm create cloudflare@latest -- --template=cloudflare/templates/lucky-credit-3b68
```

## Preview Deployment

A live public deployment of this template is available at [https://lucky-credit-3b68.templates.workers.dev](https://lucky-credit-3b68.templates.workers.dev)
